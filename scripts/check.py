...
# path_km_server_linuxsocket = log_path + "socket_server.txt"
# #
...
path_ebpf_server_linuxsocket = log_path + "socket_server.txt"
path_ebpf_kern = log_path + "EBPF_kern.txt"
path_ebpf_us = log_path + "EBPF_user.txt"
# path_ebpf_kern = log_path + "XDP_kern.txt"
# path_ebpf_us = log_path + "XDP_user.txt"
...
# #
with open(path_ebpf_server_linuxsocket) as ebpf_lus_log_f:
